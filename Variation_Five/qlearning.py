...
class QLearning:
    def __init__(self, env, alpha=0.1, gamma=0.99, epsilon=1.0,
        ...
        # Expanded action space: throttle, left+throttle, right+throttle, brake
    ...
    def discretize_state(self, observation):
        gray = np.round(observation.mean(axis=2) / 20)   # Compress grayscale to 0–12
        downsampled = gray[::8, ::8]  # 96x96 ⇒ 12x12
    ...
    def is_on_grass(self, observation):
        green_channel = observation[84:, :, 1]  # Bottom portion of the image
    ...
    def train(self, num_episodes=500, save_interval=100, verbose=False):
        for episode in range(num_episodes):
            ...
            while not episode_over:
                ...
                # Penalize being on grass and reward staying on track
